...
3 & 1 & $-\frac{3}{2} \sin{\theta} \left( 1 - 5\cos^2{\theta} \right)$ & $-\frac{\sqrt{6}}{4} \sin{\theta} \left( 1 - 5\cos^2{\theta} \right)$ & $$ & $$ \\
3 & 2 & $15 \cos{\theta} \sin^2{\theta}$ & $\frac{\sqrt{15}}{2} \cos{\theta} \sin^2{\theta}$ & $$ & $$ \\
3 & 3 & $15 \sin^3{\theta}$ & $\frac{15}{6 \sqrt{10}} \sin^3{\theta}$ & $$ & $$ \\
\bottomrule
\end{tabular}
\label{tab:ALF}
\end{table}
